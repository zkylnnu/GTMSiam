...
def get_args():
    ...
    parser.add_argument("--data_path", type=str, default="dataset/RV")
...
for repterm in range(arg.repeat_term):
    ...
    X_train1, X_train2 = Grammar(X1, X2, train_coords, method="rect 5")
    X_val1, X_val2 = Grammar(X1, X2, val_coords, method = "rect 5")
    ...
    net = model.GTMSiam(arg.max_len, xshape[-1], arg.num_hidden, arg.prembed_dim, arg.batch_size)
